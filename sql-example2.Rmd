...
This document is intended to describe how to access data from a MySQL database using R.  It utilizes a database of genetic information that has been made publically available for analysis.
